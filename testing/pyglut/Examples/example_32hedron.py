...
from pyglut import Poly32Hedron
...
def mainloop() :
  ...
  poly32hedron=Poly32Hedron(15.5,display_mode="lined",lines_color=Color(ub_v=(127,127,127,0)),pentagons_color=pentagons_faces,triangles_color=triangles_faces,lines_width=line_width,display_ls=True)
  i=5.625/4.0
  m=Matrix()
  ...
  while True :
    ...
    for event in pygame.event.get() :
	  ...
	  if faces_color_mode == 1 :
	    poly32hedron.set_pentagons_color(Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))))
	    ...
	    poly32hedron.set_pentagons_color(pentagons_faces)
	  ...
	  poly32hedron.set_side_length(uniform(1.0,17.5))
	  m=Matrix()
          m.translate((15.5,0.0,0.0))
          poly32hedron.update_pos(m)
