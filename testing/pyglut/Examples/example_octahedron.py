...
def mainloop() :
  ...
  test_octahedron=Octahedron (12.5,display_mode="lined",lines_color=Color(ub_v=(127,127,127,0)),faces_color=[Color(ub_v=(255,0,0)),Color(ub_v=(0,0,255)),Color(ub_v=(255,255,255)),Color(ub_v=(0,255,0)),Color(ub_v=(255,255,0)),Color(ub_v=(255,0,255)),Color(ub_v=(0,255,255)),Color(ub_v=(255,0,255))],lines_width=line_width,display_ls=True)
  i=5.625/4.0
  m=Matrix()
  m.translate((15.5,0.0,0.0))
  test_octahedron.update_pos(m)
  while True :
    
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)  
    
    m=Matrix()
    m.translate((-test_octahedron.center.wx,-test_octahedron.center.wy,-test_octahedron.center.wz))
    m.rotate_x(i)
    m.rotate_y(i)
    m.rotate_z(i)
    m.translate((test_octahedron.center.wx,test_octahedron.center.wy,test_octahedron.center.wz))
    ...
    for event in pygame.event.get() :
	  ...
	  display_mode += 1
	  if display_mode == 1 :
	    test_octahedron.set_display_mode("faced")
	  elif display_mode == 2 :
	    test_octahedron.set_display_mode("twice")  
	  elif display_mode == 3 :
	    display_mode=0
	    test_octahedron.set_display_mode("lined")
	    
	  
	elif event.key == K_l :
	  test_octahedron.set_lines_color(Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))))
	  
	elif event.key == K_f :
	  if faces_color_mode == 1 :
	    test_octahedron.set_faces_color(Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))))
	    faces_color_mode=0
	  elif faces_color_mode == 0 :
	    test_octahedron.set_faces_color([Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),
	  ...
	  test_octahedron.set_lines_width(line_width)
	  ...
	  test_octahedron.set_display_ls(bool_display_ls)
	
	elif event.key == K_s :
	  test_octahedron.set_side_length(uniform(1.0,17.5))
	  m=Matrix()
          m.translate((15.5,0.0,0.0))
          test_octahedron.update_pos(m)
