...
def mainloop() :
  ...
  test_cube=Cube(15.5,display_mode="lined",lines_color=Color(ub_v=(127,127,127,0)),faces_color=[Color(ub_v=(255,0,0)),Color(ub_v=(0,0,255)),Color(ub_v=(0,255,255)),Color(ub_v=(0,255,0)),Color(ub_v=(255,255,0)),Color(ub_v=(255,0,255,0))],lines_width=line_width,display_ls=True)
  i=5.625/4.0
  m=Matrix()
  ...
  while True :
    ...
    for event in pygame.event.get() :
	  ...
	  if faces_color_mode == 1 :
	    ...
	    test_cube.set_faces_color([Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))),Color(ub_v=(randint(63,255),randint(63,255),randint(63,255)))]) 
	    faces_color_mode=1
