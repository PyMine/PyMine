...
from pyglut import Trigon_Sphere 
...
def mainloop() :
  ...
  test_trigon_sphere=Trigon_Sphere(12.5,12,display_mode="lined",lines_color=Color(ub_v=(127,127,127,0)),faces_color=Color(ub_v=(255,0,0)),lines_width=line_width,display_ls=True)
  i=5.625/4.
  m=Matrix()
  ...
  while True :
    ...
    m=Matrix()
    m.translate((-test_trigon_sphere.center.wx,-test_trigon_sphere.center.wy,-test_trigon_sphere.center.wz))
    m.rotate_x(i)
    m.rotate_y(i)
    m.rotate_z(i)
    m.translate((test_trigon_sphere.center.wx,test_trigon_sphere.center.wy,test_trigon_sphere.center.wz))
    ...
    for event in pygame.event.get() :
	  ...
	  test_trigon_sphere.set_lines_color(Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))))
	  
	elif event.key == K_f :
	  test_trigon_sphere.set_faces_color(Color(ub_v=(randint(63,255),randint(63,255),randint(63,255))))
